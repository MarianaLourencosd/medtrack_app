...
class _HomeFAQState extends State<HomeFAQ> {
  ...
  final List<Map<String, String>> _faqs = [
    {
      'q': 'O que é o MedTrack?',
      'a': 'É uma carteira digital de saúde que armazena seus dados médicos com segurança.'
    },
    {
      'q': 'Como faço para cadastrar?',
      'a': 'Clique em "Cadastro" no menu e preencha seus dados.'
    },
    {
      'q': 'Meus dados são seguros?',
      'a': 'Sim, usamos criptografia e proteção de dados.'
    },
    {
      'q': 'Posso compartilhar meus dados?',
      'a': 'Sim, você pode compartilhar via QR Code ou PDF.'
    },
  ];
